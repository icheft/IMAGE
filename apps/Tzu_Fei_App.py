...
def app(stock_id='2603.TW'):
    ...
    #介紹
    st.write("Hello! 我是張子菲，這是一個股票查詢小工具!")
    
    #股票名稱
    st.write(f'分析 {stock_obj.info["longName"]}  ({stock_id})')
...
#     plt.show()
    ...
    st.write(
        f'若原有3000元，經過 {year_difference} 年後，變成 {total_balance[-1]} 元｜年化報酬率為 {cgar * 100}%')
